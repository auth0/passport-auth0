...
var clientInfo = { name: 'passport-auth0', version: pjson.version };
...
Strategy.prototype._getAccessToken = function(done){
  ...
  var encodedClientInfo = Base64Url.encode(JSON.stringify(clientInfo));
  ...
  request({
    ...
    form: body,
    headers: {
      'Auth0-Client': encodedClientInfo
    }
