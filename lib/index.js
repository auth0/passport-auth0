...
Strategy.prototype.authenticate = function (req, options) {
  ...
  if (req.query.code) {
    // The code param is sent to the /callback route
    // where code exchange and other verification will happen
    this._verify = verifyWrapper(this._verify, this.options, req.session.authParams);
  } else {
    // Store auth params in the session in order for verification on callback
